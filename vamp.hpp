...
private:
    ...
    std::vector<double> z1, z2;                             // z1 = A * x1_hat 
    ...
    double new_vars, correction;
    std::vector<double> p_last;
    double c_scale = 1;
...
public:
    ...
    std::vector<double> lmmse_denoiserAAT(std::vector<double> r, std::vector<double> mu_CG_AAT_last, std::vector<double> p_last, double *correction, double *new_vars, data* dataset);

    std::vector<double> CG_solverAAT(std::vector<double> v, std::vector<double> mu_start, std::vector<double> & p_start, double tau, double *correction, double *new_vars, int save, data* dataset);
